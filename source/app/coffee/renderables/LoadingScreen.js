...
class LoadingScreen extends PIXI.Sprite {
  constructor(callback) {
    ...
    this.preloadLoadingAssetsComplete = this.preloadLoadingAssetsComplete.bind(
      this
    );
  ...
  preloadLoadingAssetsComplete(loader, resources) {
    ...
    this.mask1.drawRect(
      this.icon1.texture.width / -2,
      this.icon1.texture.height / -2,
      this.icon1.texture.width,
      this.icon1.texture.height
    );
    ...
    this.mask2.drawRect(
      this.icon3.texture.width / -2,
      this.icon3.texture.height / -2,
      this.icon3.texture.width,
      this.icon3.texture.height
    );
