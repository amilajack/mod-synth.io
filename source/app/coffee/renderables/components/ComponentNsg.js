...
class ComponentNsg extends ComponentBase {
  ...
  change() {
    if (Session.SETTINGS[this.component_session_uid].settings.mute === true) {
      ...
      Session.SETTINGS[this.component_session_uid].settings.mute === false
    ) {
    ...
    switch (Session.SETTINGS[this.component_session_uid].settings.noise_type) {
      case AppData.NOISE_TYPE.WHITE:
        this.icon.texture =
          AppData.ASSETS.sprite.textures["ic-noise-white-48.png"];
        break;
      case AppData.NOISE_TYPE.PINK:
        this.icon.texture =
          AppData.ASSETS.sprite.textures["ic-noise-pink-48.png"];
        break;
      case AppData.NOISE_TYPE.BROWN:
        this.icon.texture =
          AppData.ASSETS.sprite.textures["ic-noise-brown-48.png"];
        break;
    }
    return null;
  }
