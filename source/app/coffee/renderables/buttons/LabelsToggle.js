...
class LabelsToggle extends PIXI.Container {
    ...
    constructor(selected) {
        ...
        const img = new PIXI.Sprite(AppData.ASSETS.sprite.textures['help-toggle-bg.png']);
        img.anchor.x = 0.5;
        img.anchor.y = 0;
    ...
    swap() {
        TweenMax.to(this.selector, 0.3, { x: (this.selected === true ? 49 : 32) * AppData.RATIO, alpha: (this.selected === true ? 1 : 0.5), ease: Power2.easeInOut });
