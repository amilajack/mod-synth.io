...
class KeyboardPannel extends PIXI.Sprite {
  constructor() {
    ...
    this.hitArea = new PIXI.Rectangle(
      ...
      100 * AppData.RATIO,
      AppData.WIDTH,
      AppData.KEYBOARD_PANNEL_HEIGHT
    );
  }
  ...
  resize() {
    ...
    this.graphics.lineTo(
      AppData.WIDTH,
      AppData.SETTINGS_PANNEL_HEIGHT + AppData.KEYBOARD_PANNEL_HEIGHT
    );
    this.graphics.lineTo(
      0,
      AppData.SETTINGS_PANNEL_HEIGHT + AppData.KEYBOARD_PANNEL_HEIGHT
  ...
  removeKeys() {
    for (
      let i = 0, end = this.keys.children.length, asc = 0 <= end;
      asc ? i < end : i > end;
      asc ? i++ : i--
    ) {
  ...
  addKeys() {
    ...
    const availableWidth =
      AppData.WIDTH - 110 * AppData.RATIO - AppData.PADDING;
    ...
    this.octaveUp.x =
      AppData.PADDING - (this.octaveUp.width - AppData.ICON_SIZE_1) / 2;
    this.octaveUp.y =
      AppData.KEYBOARD_PANNEL_HEIGHT - this.kh - AppData.PADDING - this.p;
    ...
    this.octaveDown.x =
      AppData.PADDING - (this.octaveUp.width - AppData.ICON_SIZE_1) / 2;
    this.octaveDown.y =
      AppData.KEYBOARD_PANNEL_HEIGHT - this.kh - AppData.PADDING;
