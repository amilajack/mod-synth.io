...
class AddPannel extends Pannel {
    ...
    constructor(label) {
        ...
        this.nsg = new SubmenuButtonAdd('Noise Generator',
        ...
        this.osc = new SubmenuButtonAdd('Oscillator',
        ...
        this.env = new SubmenuButtonAdd('Envelope',
        ...
        this.flt = new SubmenuButtonAdd('Filter',
        ...
        this.ptg = new SubmenuButtonAdd('Pattern Gate',
        ...
        this.lfo = new SubmenuButtonAdd('Low Frequency Oscillator',
