class Soon extends PIXI.Sprite {
    ...
    constructor() {
        ...
        this.hint = new PIXI.Text('Your device resolution is too small.', AppData.TEXTFORMAT.SOON);
        ...
        this.hint2 = new PIXI.Text('Please visit on your Desktop or Tablet.', AppData.TEXTFORMAT.SOON);
