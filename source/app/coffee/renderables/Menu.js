...
class Menu extends PIXI.Container {
  ...
  build() {
    this.login = new MenuButton(
      AppData.ASSETS.sprite.textures["ic-login-48.png"],
      "login"
    );
    ...
    this.add = new MenuButton(
      AppData.ASSETS.sprite.textures["ic-add-48.png"],
      "add"
    );
    ...
    this.patches = new MenuButton(
      AppData.ASSETS.sprite.textures["ic-patches-48.png"],
      "patches"
    );
    ...
    this.presets = new MenuButton(
      AppData.ASSETS.sprite.textures["ic-presets-48.png"],
      "presets"
    );
    ...
    this.midi = new MenuButton(
      AppData.ASSETS.sprite.textures["ic-midi.png"],
      "midi"
    );
    ...
    for (
      let i = 0, end = this.tabs.length, asc = 0 <= end;
      asc ? i < end : i > end;
      asc ? i++ : i--
    ) {
  ...
  adjustPosition() {
    for (
      let i = 0, end = this.buttons.length, asc = 0 <= end;
      asc ? i < end : i > end;
      asc ? i++ : i--
    ) {
