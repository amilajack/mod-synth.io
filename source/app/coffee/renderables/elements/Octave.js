...
class Octave extends Slider {
  constructor(component_session_uid) {
    ...
    this.possibleValues = [
      AppData.OCTAVE_TYPE.THIRTY_TWO,
      AppData.OCTAVE_TYPE.SIXTEEN,
      AppData.OCTAVE_TYPE.EIGHT,
      AppData.OCTAVE_TYPE.FOUR
    ];
  ...
  onEnd(e) {
    ...
    if (this.lastValue === this.percentage) {
      let next =
        Session.SETTINGS[this.component_session_uid].settings.octave + 1;
