...
class Oscillator extends Component {
    static initClass() {
        ...
        this.property('type', {
            ...
            set(value) {
                ...
                for (let i = 0, end = this.activeOscillators.length, asc = 0 <= end; asc ? i < end : i > end; asc ? i++ : i--) {
        ...
        this.property('detune', {
            ...
            set(value) {
                if (this.parameters.detune === value) { return this.parameters.detune; }
        ...
        this.property('octave', {
            ...
            set(value) {
                if (this.parameters.octave === value) { return this.parameters.octave; }
        ...
        this.property('portamento', {
            ...
            set(value) {
                if (this.parameters.portamento === value) { return this.parameters.portamento; }
        ...
        this.property('poly', {
            ...
            set(value) {
                if (this.parameters.poly === value) { return this.parameters.poly; }
    ...
    create(frequency) {
        ...
        oscillator.frequency.setTargetAtTime(frequency * this.parameters.octave * Audio.CUR_OCTAVE[Audio.OCTAVE_STEP], 0, (this.parameters.portamento / 1000.0) || 0.001);
    ...
    start(frequency) {
        ...
        if (this.parameters.poly || (this.activeOscillators.length === 0)) {
            ...
            this.activeOscillators[0].frequency.setTargetAtTime(frequency * this.parameters.octave * Audio.CUR_OCTAVE[Audio.OCTAVE_STEP], 0, (this.parameters.portamento / 1000.0) || 0.001);
        }
        return null;
    }
    ...
    stop(frequency) {
        ...
        if (index !== -1) {
            ...
            if ((this.parameters.poly === true) || (this.active.length === 0)) {
                let rampValue = this.getRampValue(0, 1, this.activeOscillators[index].nofg.attackStart, this.activeOscillators[index].nofg.attackEnd, now);
                ...
                this.activeOscillators[0].frequency.cancelScheduledValues(now);
                this.activeOscillators[0].frequency.setTargetAtTime(this.active[this.active.length-1] * this.parameters.octave, 0, (this.parameters.portamento / 1000.0) || 0.001);
            }
        }
        return null;
    }
