...
class PixiBase extends Base {
  ...
  constructor() {
    ...
    AppData.PIXI.renderer.view.addEventListener(
      "contextmenu",
      this.handleContext,
      false
    );
  ...
  handleResize() {
    ...
    AppData.PIXI.renderer.view.style.width =
      AppData.WIDTH / AppData.RATIO + "px";
    AppData.PIXI.renderer.view.style.height =
      AppData.HEIGHT / AppData.RATIO + "px";
    App.RESIZE.dispatch();
    return null;
  }
