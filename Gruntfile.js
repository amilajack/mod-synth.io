module.exports = function(grunt) {
    grunt.initConfig({
        ...
        watch: {
            app: {
                files: ['Gruntfile.js', 'source/app/coffee/**/*coffee', 'source/app/sass/*.sass'],
    ...
    return grunt.registerTask('dev', ['clean:all', 'copy', 'percolator:app', 'sass:app', 'connect', 'watch:app']);
};
